...
public class Date
{
            ...
            throws Exception
  {
    ...
    checkDateIsLegal();  //  checkDateIsLegal();
  } // Date
  ...
  public Date addMonth()
  {
    ...
    catch(Exception exception1)
    {
        ...
        {
            try{return new Date(daysInMonth(1, year + 1), 1, year + 1);}
            catch(Exception exception3)
            {return null;}
      }
    }
  ...
  public Date subtractDay() throws Exception
  {
    ...
    catch(Exception exception1)
    {
      ...
      catch(Exception exception2)
      {
        ...
        {throw new Exception("No dates before 1753 allowed!");}
      }
    }
  } // subtractDay
  ...
  public Date subtractMonth() throws Exception
  {
    ...
    catch(Exception exception1)
    {
      ...
      {
        try{return new Date(day -1, 12, year-1);}
        catch(Exception exception3)
        {throw new Exception("No dates before 1753 allowed!");}
      }
    }
